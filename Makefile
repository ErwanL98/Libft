...
#    Updated: 2017/01/18 13:08:27 by ele-cren         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	  ...
	  ft_lstiter.c ft_isescape.c ft_powten.c ft_count.c ft_lstmap.c \
	  ft_swap.c ft_strndup.c ft_freestrjoin.c get_next_line.c
